/*
  ...
  - The values [SCIENCES_VIE] on the enum `Theme` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."Theme_new" AS ENUM ('CINEMA_SERIES', 'ARTS_CULTURE', 'JEUX_BD', 'GEOGRAPHIE', 'LANGUES_LITTERATURE', 'ECONOMIE_POLITIQUE', 'GASTRONOMIE', 'CROYANCES', 'SPORT', 'HISTOIRE', 'DIVERS', 'SCIENCES_NATURELLES', 'SCIENCES_TECHNIQUES', 'MUSIQUE', 'ACTUALITES_MEDIAS');
