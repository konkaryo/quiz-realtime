...
export default function RegisterConfirmationPage() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "calc(100dvh - 52px)", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 16px 72px", color: "#f8fafc", fontFamily: "system-ui, sans-serif" }}>
      <Background />
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420, background: "#1E2030", borderRadius: 10, padding: "32px 28px", border: "1px solid rgba(255,255,255,.08)", boxShadow: "0 25px 60px rgba(0,0,0,.45)", display: "grid", gap: 16 }}>
