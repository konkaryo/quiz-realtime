export function HomePageBackground() {
  return (
    <>
      ...
      >
        <defs>
          <linearGradient id="homePageBackgroundWaveA" x1="0" x2="1" y1="0" y2="0">
          ...
          <linearGradient id="homePageBackgroundWaveB" x1="0" x2="1" y1="0" y2="0">
        ...
        <path
          ...
          fill="url(#homePageBackgroundWaveA)"
        />
        <path
          ...
          fill="url(#homePageBackgroundWaveB)"
        />
        <path
